...
class OtpScreenController extends GetxController {
  ...
  void onInit() {
    ...
    // Get email and reset password flag from route arguments
    final arguments = Get.arguments as Map<String, dynamic>?;
    log(arguments.toString());
    if (arguments != null && arguments['email'] != null) {
      email = arguments['email'] as String;
      isResetPassword = arguments['isResetPassword'] as bool? ?? false;
    } else {
  ...
  Future<void> verifyOtp() async {
    ...
    bool hasInternet = await InternetRequiredService.checkForOtpVerification();
    if (!hasInternet) {
    ...
    try {
      ...
      if (isResetPassword) {
        // For reset password flow - simulate OTP verification
        service.verifyOtp(model);
        log(":::::::::::::::::::::::$isResetPassword");
        // Navigate to reset password screen
        Get.offNamed(NAV_RESET_PASSWORD, arguments: {'email': email});
